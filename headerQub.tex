...
\usepackage{animate}
\usepackage{verse}
% Used to embed youtube video in intro
\usepackage{media9}
\usepackage[style=british]{csquotes}
% Used  for clickable image
...
{\color{black}\raggedright\usebeamerfont{title}\par\inserttitle}
\end{textblock}
\begin{textblock}{7.5}(1,7.3)
{\color{black}\raggedright{\insertauthor}\\[0.2cm]
\insertdate}
\end{textblock}}
